        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-16">
          <div className="lg:col-span-2">
            <div className="lg:sticky lg:top-24">
              <h2 className="font-display text-sm font-bold text-primary tracking-[0.2em] uppercase mb-6">
                &lt;about&gt;
              </h2>
              <div className="space-y-2 bg-surface-container rounded-md p-4 border border-outline-variant/20">
                {info.map((item) => (
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="border-t border-outline-variant/20 pt-6">
              <h3 className="font-code text-xs font-bold text-primary tracking-wider uppercase mb-4">
                &gt; education
              </h3>
              <div className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-primary mt-2 shrink-0 rounded-full" />
                <div>
                  <span className="font-display text-base font-bold text-white">Informatics</span>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4">
              {stats.map((stat) => (
                <div key={stat.label} className="bg-surface-container border border-outline-variant/20 rounded p-4 text-center">
