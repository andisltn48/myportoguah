...
const contributionTheme = {
  ...
  dark: ['#141414', '#1a0a0a', '#2a0f12', '#3d1418', '#e50914'],
}
      ...
      <div className="max-w-[1100px] mx-auto px-4 lg:px-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {projects.map((project) => (
            <a
              ...
              className="group bg-surface-container border border-outline-variant/20 rounded-md overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_30px_rgba(229,9,20,0.15)] hover:border-primary/50 flex flex-col cursor-pointer"
            >
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-block px-2 py-1 font-code text-[10px] font-bold uppercase tracking-wider bg-surface text-on-surface-variant/80 border border-outline-variant/20 rounded"
                    >
                      {tag}
                    </span>
                  ))}
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 border border-outline text-on-surface-variant font-semibold text-sm rounded hover:border-primary hover:text-primary transition-all duration-300"
          >
